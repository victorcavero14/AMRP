...
/**
 *
 * Desarrollado por: Victor Manuel Cavero Gracia
 */
public class Representacion extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        setTitle("Representaci�n de un �rbol 2-3-4");
        setResizable(false);
        ...
        jPanel3Layout.setVerticalGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel3Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel3Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(buscar, javax.swing.GroupLayout.DEFAULT_SIZE,
                                        javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                .addGroup(jPanel3Layout.createSequentialGroup()
                                        .addComponent(insertar, javax.swing.GroupLayout.PREFERRED_SIZE, 45,
        ...
        jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                .addComponent(textField1, javax.swing.GroupLayout.PREFERRED_SIZE, 187,
                                        javax.swing.GroupLayout.PREFERRED_SIZE)
    ...
    private void insertarActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            if (!_arbol.insertar(Integer.parseInt(textField1.getText()))) {
                JFrame jf = new JFrame();
                JOptionPane.showMessageDialog(jf, "El valor ya existe en el árbol", "Error", JOptionPane.ERROR_MESSAGE);
            }
            representa_arbol();
        } catch (NumberFormatException ex) {
            JFrame jf = new JFrame();
            JOptionPane.showMessageDialog(jf, "Inserte un numero.", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
    ...
    private void buscarActionPerformed(java.awt.event.ActionEvent evt) {
        ...
        try {
            if (_arbol.buscar(Integer.parseInt(textField1.getText())) != null) {
                JOptionPane.showMessageDialog(jf, "¡Hemos encontrado el valor!");
            } else {
                JOptionPane.showMessageDialog(jf, "No he encontrado el valor.", "Error", JOptionPane.ERROR_MESSAGE);
            }
        } catch (NumberFormatException ex) {
    ...
    private void borrarActionPerformed(java.awt.event.ActionEvent evt) {
        try {
            if (!_arbol.borrar(Integer.parseInt(textField1.getText()))) {
                JFrame jf = new JFrame();
                JOptionPane.showMessageDialog(jf, "No existe el valor o el árbol es vacio.", "Error",
    ...
    private void arbol_recursivo(Nodo arbol, DefaultMutableTreeNode root) {
        if (arbol != null) {
            ...
            if (ci != null
                    && ((arbol.get_tipo() == TiposNodos.NODOTRES) || (arbol.get_tipo() == TiposNodos.NODOCUATRO))) {
